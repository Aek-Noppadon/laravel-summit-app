        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                        ...
                        <div class="btn-group w-100" role="group">
                            ...
                            @can('customer.create')
                                <button wire:click="$dispatch('refresh-customer-ax')" type="button"
                                    class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal-customer-ax">
                                    <span data-toggle="tooltip" data-placement="bottom" data-original-title="Add Customer">
                ...
                <div class="table-responsive">
                    ...
                    @livewire('customer.customer-ax-lists-modal')
