<div wire:ignore.self class="modal fade" id="modal-add-probability" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Probability new</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="name" class="form-label">Probability Name</label>
    ...
    <script>
        document.addEventListener('livewire:initialized', () => {
            @this.on('close-modal-probability', (event) => {
                // alert('Close Modal')
                setTimeout(() => {
                    @this.dispatch('refresh-probability')
                    @this.dispatch('reset-modal')
                    $('#modal-add-probability').modal('hide')
                }, 3000);
            })
