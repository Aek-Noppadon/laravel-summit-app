                ...
                @foreach ($inputs as $key => $item)
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    <label for="inputs.{{ $key }}.application"
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    <label for="inputs.{{ $key }}.probability"
                    ...
                    <div class="card-footer">
                        <div class="row">
                            @if ($crm_detail_id)
                                ...
                                <div class="col-6">
                                    <button
                                        wire:click.prevent="deleteItem({{ $crm_detail_id }},{{ "'" . $product_name . "'" }})"
                                        {{-- wire:confirm="Are you sure want to delete item"  --}} class="btn btn-danger w-100">
                            ...
                            @else
                                ...
                                <div class="col-6">
                                    ...
                                    <button
                                        wire:click.prevent="removeItem({{ $key }},{{ "'" . $product_name . "'" }})"
