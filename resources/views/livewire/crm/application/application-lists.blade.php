<div wire:ignore.self class="modal fade" id="modal-application" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Application Lists</h4>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-3 d-flex justify-content-center">
                        <div class="btn-group w-100" role="group">
                            ...
                            @livewire('crm.application.application-create')
                            <!-- ./Application Add Component -->
                        ...
                        <tbody>
                            @foreach ($applications as $item)
                                <tr>
                                    ...
                                    <td>
                                        <button
                                            wire:click.prevent="$dispatch('edit-application',{id:{{ $item->id }}})"
                                        ...
                                        <button
                                            ...
                                            {{-- wire:click.prevent="deleteApplication({{ $item->id }},{{ "'" . $item->name . "'" }})" --}} class="btn btn-sm btn-danger">
                            ...
                            @livewire('crm.application.application-edit')
                            <!-- ./Application Edit Component -->
...
@script
    <script>
        $wire.on("confirm-delete-application", (event) => {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $wire.dispatch("destroy-application", {
                        id: event.id,
                        name: event.name,
                    })
                }
