<div wire:ignore.self class="modal fade" id="modal-add-customer-type" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Customer Type Form</h3>
                    </div>
    ...
    <script>
        document.addEventListener('livewire:initialized', () => {
            @this.on('close-modal-customer-type', (event) => {
                // alert('Close Modal')
                setTimeout(() => {
                    @this.dispatch('refresh-customer-type')
                    @this.dispatch('reset-modal')
                    $('#modal-add-customer-type').modal('hide')
                }, 3000);
            })
