<div wire:ignore.self class="modal fade" id="preventive-action-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Preventive Action Lists</h4>
                ...
                <div class="row mb-4">
                    <div class="col-md-7 col-12">
                        <input wire:model.live.debounce.1000ms="search" type="search" class="form-control"
                            placeholder="Search preventive action">
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover table-bordered">
                        <thead class="table-info">
                            ...
                            <th scope="col">Id</th>
                            <th scope="col">Preventive Action Name</th>
                        ...
                        <tbody>
                            @foreach ($preventiveActions as $item)
                                <tr>
                                    ...
                                    <td style="width: 40px" class="p-1 text-center">
                                        <button
                                            wire:click.prevent="$dispatch('select-preventive-action',{id:{{ $item->id }}})"
                                            class="btn btn-success btn-sm">
                            ...
                            {{-- @livewire('preventive-action.edit-modal') --}}

                        </tbody>
                    </table>

                    @livewire('preventive-action.create-modal')
    ...
    <script>
        $wire.on("confirm", (event) => {
            Swal.fire({
                ...
                text: `Preventive Action : ${event.name}`,
                icon: "warning",
        ...
        document.addEventListener('livewire:initialized', () => {
            @this.on('close-preventive-action-modal', (event) => {
                ...
                setTimeout(() => {
                    ...
                    $('#modal-edit-preventive-action').modal('hide')
                }, 3000);
