...
class ListsModal extends Component
{
    ...
    #[On('refresh-found-activity')]
    public function render()
    {
        $foundActivities = FoundActivity::query()
        ...
        return view('livewire.found-activity.lists-modal', compact('foundActivities'));
    }
    ...
    public function destroy($id, $name)
    {
        try {
            ...
            $foundActivity->delete();

            $this->dispatch(
                "sweet.success",
                position: "center",
                title: "Deleted Successfully !!",
                text: "Found During Activity : " . $name,
                icon: "success",
                timer: 3000,
            );
